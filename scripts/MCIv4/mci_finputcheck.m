...
%
% Usage: >> result = mci_finputcheck( varargin, fieldlist );
%        >> [result varargin] = mci_finputcheck( varargin, fieldlist, ... 
...
function [g, varargnew] = mci_finputcheck( vararg, fieldlist, callfunc, mode, verbose )
